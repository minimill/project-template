...
gulp.task("responsive:metadata", function (done) {
  ...
  var metadata = {
    _NOTE:
      "This file is generated in gulpfile.js, in the responsive:metadata task.",
    aspectRatios: {},
    sizes: responsiveSizes,
  };
  var travelPhotos = {};
  return gulp
    .src("./_img/res/raw/**/*.{jpg,JPG,png,PNG,jpeg,JPEG,gif,GIF}")
    .pipe(
      flatmap(function (stream, file) {
        fs.readFile(file.path, function (err, buf) {
          ...
          metadata.aspectRatios[key] = Number(
...
gulp.task("deploy:rsync", function (done) {
  cp.exec(
    "chmod -R 775 _site && rsync -avuzh _site/* dan:/srv/MYWEBSITE.COM/public_html/",
    function () {
      process.stdout.write("Deployed to MYWEBSITE.COM\n");
      done();
    }
